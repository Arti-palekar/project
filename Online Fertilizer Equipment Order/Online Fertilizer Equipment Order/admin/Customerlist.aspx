                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <ol class="breadcrumb pull-right">
                                <li class="breadcrumb-item"><a href="Dashboard.aspx"><i data-feather="home"></i></a></li>
            ...
            <form id="form1" runat="server">
                ...
                <Columns>
                    <asp:TemplateField HeaderText="ID">
                     <ItemTemplate>
                            <asp:Label ID="person_id" runat="server" Text='<%#Eval("person_id") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Actions">
                        <ItemTemplate>
                            ...
                            <asp:LinkButton ID="lnkbtnDelete" CommandName="lnkbtnDelete" CommandArgument='<%#Eval("FirstName") %>' runat="server">Delete</asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
