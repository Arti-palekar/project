            ...
            <div class="container-fluid">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Category Image">
                        <ItemTemplate>
                            <asp:Image ID="imgProfilePicture" runat="server" ImageUrl='<%#  "data:image/jpg;base64," + Convert.ToBase64String((byte[])Eval("Data"))%>' Style="height: 100px; width: 100px;"></asp:Image>
                        </ItemTemplate>
                    </asp:TemplateField>
