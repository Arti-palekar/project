<%@ Page Language="C#" AutoEventWireup="true" CodeFile="productlist.aspx.cs" Inherits="back_end_Category" %>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <link rel="icon" href="../assets/logo.jfif" type="image/x-icon">
...
<div class="page-wrapper">
    ...
    <div class="page-main-header">
        <div class="main-header-right row">
            ...
            <div class="nav-right col">
                <ul class="nav-menus">
                     <h4 style="color:deeppink">Online Fertilizer Equipment Order System</h4>
                    <li>
  ...
  <!-- Page Sidebar Ends-->
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="page-header-left">
                                <h3>Product-List
                                    <small>Online Fertilizer Equipment Order System Admin panel</small>
                                </h3>
                            </div>
                        </div>
                        <div class="col-lg-6">
                                         ...
                                         <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title f-w-600" id="exampleModalLabel">Add Product-List  </h5>
        ...
        <asp:ImageField DataImageUrlField="Image1Url" HeaderText="Image" ControlStyle-Width="100px" ControlStyle-Height="100px" />
         <asp:BoundField DataField="price" HeaderText="Product Price" SortExpression="pid" />
        
          <asp:BoundField DataField="psize" HeaderText="Product Size" SortExpression="pid" />
        <asp:BoundField DataField="totalproducts" HeaderText="Total Products" SortExpression="pid" />
               

                    
                    <asp:TemplateField HeaderText="Actions">
                        <ItemTemplate>
                           <!-- <asp:LinkButton ID="lnkbtnEdit" CommandName="lnkbtnEdit" CommandArgument='<%#Eval("PID") %>' runat="server">Edit</asp:LinkButton>-->
                            <asp:LinkButton ID="lnkbtnDelete" CommandName="lnkbtnDelete" CommandArgument='<%#Eval("PID") %>' runat="server">Delete</asp:LinkButton>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 footer-copyright">
                        <p class="mb-0">Copyright 2024@ Online Fertilizer Equipment Order System</p>
                    </div>
                    <div class="col-md-6">
