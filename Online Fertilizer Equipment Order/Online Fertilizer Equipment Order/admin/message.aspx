<%@ Page Language="C#" AutoEventWireup="true" CodeFile="message.aspx.cs" Inherits="back_end_Category" %> 
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Online Fertilizer Equipment Order Systeme</title>
...
<div class="page-wrapper">
  ...
  <!-- Page Sidebar Ends-->
        ...
        <div class="page-body">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Email">
                        <ItemTemplate>
                            ...
                            <asp:Label ID="lbltitle" runat="server" Text='<%#Eval("Email") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                      <asp:TemplateField HeaderText="Subject">
                        <ItemTemplate>

                            <asp:Label ID="lblprice" runat="server" Text='<%#Eval("Subject") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                      <asp:TemplateField HeaderText="Message">
                        <ItemTemplate>

                            <asp:Label ID="lblprice" runat="server" Text='<%#Eval("Message") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
            ...
            <ItemTemplate>
                <asp:Image ID="imgProduct" runat="server" ImageUrl='<%# Eval("Image1Url")%>' Height="100" Width="100" />
            </ItemTemplate>
        </asp:TemplateField>--%>
