<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Other.aspx.cs" Inherits="Electronic" %>
                        ...
                        <div class="main-menu">
                            <div class="menu-left">
                                ...
                                <div class="brand-logo">
                                    <a href="Default.aspx"><img src="../assets/logo2.png" class="img-fluid blur-up lazyload" alt=""></a>
                                </div>
                            </div>
                    ...
                    <div class="collection-content col">
                        <div class="page-main-content">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="top-banner-wrapper">
                                      <!--  <a href="#"><img src="../assets/bg2.jpg" style="height:385px; width:1370px"" class="img-fluid blur-up lazyload" alt=""></a>-->
                                        <div class="top-banner-content small-section">
                                               <h4>Product Category</h4>
                                            <h5>Other  </h5>
                                            <p> Explore our miscellaneous category featuring a wide array of specialized plastic products. From custom-molded components and packaging solutions to specialty materials and accessories, this category encompasses a diverse range of offerings tailored to meet unique requirements and specifications.</p>
                                        </div>
                                    </div>
                                    <div class="collection-product-wrapper">
                                        <div class="product-top-filter">
