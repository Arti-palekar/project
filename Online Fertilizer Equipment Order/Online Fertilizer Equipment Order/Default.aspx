...
<body>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="header-contact">
                            <ul>
                                <li>WELCOME TO Online Fertilizer Equipment Order System</li>
                    ...
                    <div class="main-menu">
                        <div class="menu-left">
                            ...
                            <div class="brand-logo">
                                <a href="Default.aspx"><img src="../assets/logo2.png"
                            ...
                            <a href="Default.aspx"> <h2 style="color:mediumvioletred">Online Fertilizer Equipment Order System</h2></a>
 ...
 <div class="icon-nav">
    ...
    <!-- Home slider -->
    <section class="p-0" style="background:linear-gradient(180deg,  rgb(60, 181, 58),rgb(255,255,255))"> 
                          ...
                          <div class="row align-items-center">
                             <div class="col-6"  >
                                    <div class="banner-contain" style="text-align: ;  text-transform: none">
                                         <h2 style="font-size: 20px; font-family:Arial; text-transform: none; color:black;">WELCOME TO Online Fertilizer Equipment Order System</h2>
                                         <h4 style="font-size: 15px; color: purple; class=text-desc;  text-transform: none">The farming equipment project aims to provide farmers in India with access to high-quality and innovative agricultural machinery. </h4>
                             ...
                             <div class="col-6"   >
                                  <div class="banner-contain" >
                                    ...
                                    <img src="../assets/images/home-banner/farm.jpg" alt=""  style="height:100%; width:100%;">
                              </div>
                                 </div>
                          </div> 
            ...
            <div class="row partition2">
                <div class="col-md-6">
                    <a href="CategoryPage.aspx">
                        <div class="collection-banner p-right text-center">
                            ...
                            <div class="contain-banner">
                                <div>
                                    <h4 > </h4>
                                    <h2 style="color:palevioletred ">Equipment</h2>
                                </div>
                            </div>
                        </div>
                    </a>
                   ...
                   <a href="CategoryPage2.aspx">
                        <div class="collection-banner p-right text-center">
                            <div class="img-part">
                                <img src="../assets/fertilizer.jpg" class="img-fluid blur-up lazyload bg-img"
                                    alt="">
                            </div>
                            <div class="contain-banner">
                                <div>
                                    <h4 > </h4>
                                     <h2 style="color:palevioletred ">Fertilizer</h2>
                                </div>
                            </div>
                        </div>
                    </a>
